...
syn match pqIdentifier "[a-z][a-z0-9$_#]*"

" Power Query statements
syn keyword pqStatement let in section sections shared
...
" Power Query Column names
syn region pqColumn matchgroup=pqParen start=/\[/ end=/\]/
...
syn match pqOperator "*"
syn match pqOperator "/"
syn match pqOperator "\<\(NOT\|AND\|OR\|AS\|IS\|META\)\>"
syn match pqOperator "??"
syn match pqOperator "&&"
syn match pqOperator "[<>]=\="
syn match pqOperator "<>"
...
syn keyword pqFunction 
  ...
  \ BinaryFormat.UnsignedInteger64 Byte.From Cdm.Contents
  ...
  \ Cube.Transform Currency.From DB2.Database
  ...
  \ DateTimeZone.ZoneMinutes Decimal.From DeltaLake.Metadata
  \ DeltaLake.Table Diagnostics.ActivityId Diagnostics.CorrelationId
  \ Diagnostics.Trace DirectQueryCapabilities.From Double.From
  ...
  \ Guid.From HdInsight.Containers HdInsight.Contents
  \ HdInsight.Files Hdfs.Contents Hdfs.Files
  \ Html.Table Identity.From Identity.IsMemberOf
  \ IdentityProvider.Default Informix.Database Int16.From
  \ Int32.From Int64.From Int8.From
  ...
  \ Number.ToText OData.Feed Odbc.DataSource
  \ Odbc.InferOptions Odbc.Query OleDb.DataSource
  \ OleDb.Query Oracle.Database Pdf.Tables
  \ Percentage.From PostgreSQL.Database Progress.DataSourceProgress
